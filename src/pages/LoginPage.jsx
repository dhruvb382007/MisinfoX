...
import { Zap, LoaderIcon, ArrowRight } from 'lucide-react';
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0c0414] text-white flex items-center justify-center px-4 relative pt-20">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[40rem] h-[40rem] bg-indigo-500/10 blur-[120px] rounded-full pointer-events-none" />
      ...
      >
        <div className="bg-[#1c1528] rounded-3xl p-8 shadow-2xl border border-white/5 backdrop-blur-xl">
          ...
          <h2 className="text-3xl font-bold font-instrument text-center mb-2">Welcome Back</h2>
          <p className="text-white/40 text-center text-sm font-cabin mb-8">Sign in to access your analysis dashboard</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full bg-black/30 border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/50 transition-all font-cabin"
